...
//bool TileMaps::load(const std::string& tileset, sf::Vector2u tileSize, const int*
...
//			int tileNumber = tileset[i + j * width];
//			int tu = tileNumber % (m_tileset.getSize().x / tileSize.x);
//			int tv = tileNumber / (m_tileset.getSize().x / tileSize.x);
//
//			//Obtenim un puter als vertex dels triagles de la fitxca actual
...
//
//}
// void TileMaps::draw(sf::RenderTarget& target, sf::RenderStates states) const
//{
//		//apply the transform
